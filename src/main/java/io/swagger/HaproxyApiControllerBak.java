...
public class HaproxyApiControllerBak implements ConfigApi {

    private static Logger logger = org.slf4j.LoggerFactory.getLogger(HaproxyApiControllerBak.class);
    ...
    public HaproxyApiControllerBak() {
        //TODO 로딩.
        config = new Config();
    }
