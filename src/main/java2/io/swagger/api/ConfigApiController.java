...
public class ConfigApiController implements ConfigApi {
    ...
    public ResponseEntity<Map<String, InlineResponse2001>> getBackends() {
        // do some magic!
        return new ResponseEntity<Map<String, InlineResponse2001>>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<Map<String, InlineResponse2002>> getServers(@ApiParam(value = "ID of backend",required=true ) @PathVariable("backendId") String backendId) {
        // do some magic!
        return new ResponseEntity<Map<String, InlineResponse2002>>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<Map<String, InlineResponse200>> newFrontend(@ApiParam(value = "The frontend to create." ,required=true )  @Valid @RequestBody Frontend frontend) {
        // do some magic!
        return new ResponseEntity<Map<String, InlineResponse200>>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<Void> updateBackends(@ApiParam(value = "The backends to update." ,required=true )  @Valid @RequestBody Object body) {
        // do some magic!
        return new ResponseEntity<Void>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<Void> updateFrontends(@ApiParam(value = "The frontends to update." ,required=true )  @Valid @RequestBody Object body) {
        // do some magic!
        return new ResponseEntity<Void>(HttpStatus.OK);
    }
